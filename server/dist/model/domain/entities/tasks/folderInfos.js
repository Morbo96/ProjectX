...
let FolderInfo = class FolderInfo extends sequelize_typescript_1.Model {
};
...
], FolderInfo.prototype, "previousFolderId", void 0);
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => folders_1.Folder),
    sequelize_typescript_1.Column,
    __metadata("design:type", Number)
], FolderInfo.prototype, "nextFolderId", void 0);
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => folders_1.Folder),
    sequelize_typescript_1.Column,
    __metadata("design:type", Number)
