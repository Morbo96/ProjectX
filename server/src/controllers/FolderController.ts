...
export class FolderController {
  ...
  async createChildAssociation(req: Request, res: Response) {//FUTURE for child-parent association between Folders
    try {
      const parentFolder = await folderService.createChildAssociation(req.body.folderId,req.body.childId);
