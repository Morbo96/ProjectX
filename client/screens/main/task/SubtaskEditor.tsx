...
function SubtaskEditor({ navigation }: Props):JSX.Element{
    return (
        <ScreenView style={taskScreen.mainView}>
            <View>
                ...
                <View style={[{paddingLeft:55}]}>
                    <View style={[flex.d_flex, flex.flex_column]}>
                        ...
                        <Text style={[subtaskEditScreen.fromTaskText]}>Название задачи</Text>
                    </View>
            ...
            <TextInput multiline={true} style={[{width:"90%"}, padding.p_5, subtaskEditScreen.taskDescriptionText]}/>
        </ScreenView>
    )
}
