...
import { taskButton, circleAreaColorProgress, fillCircleAreaColor } from "../../styles/screens/components/taskWithProgressBar"
...
const TaskWithProgressBar = ({progressValue, image, style }:Props) => {
    ...
    return(
        <View style={[taskButton.layout, style]}>
            ...
            <Text style={[taskButton.progressValueText, padding.pl_2]}>{progressValue.toString() + "%"}</Text>
        </View>
    )
}
